...
_[MusicAgent](https://github.com/janvanwassenhove/MusicAgent) is a MAS (Multi-Agent-System) I developed for composing music while coding tracks in Sonic PI. It generates a complete new song, with lyrics and album cover based on user input using GPT agents._

Read all about how **MusicAgent** works in my blog posts

-   [Rise of the GPT music agent](/blog/rise-of-the-gpt-music-agent/)
-   [MusicAgent 1.0.0 – Now with 100% More Musical Magic!](/blog/musicagent-1-0-0-now-with-100-more-musical-magic/)
-   [Introducing MusicAgent 1.1.0: Bringing in Anthropic!](/blog/introducing-music-agent-1-1-0-enhancing-creativity-with-new-features/)
-   [Unveiling Music Agent 1.2.0: A Revolutionary Web Experience for Music Creation](/blog/unveiling-music-agent-1-2-0-a-revolutionary-web-experience-for-music-creation/)
-   [Music Agent v1.3.0 – Now Supporting Samples!](/blog/music-agent-v1-3-0-now-supporting-samples/)
-   [Yamnet Integration for Enhanced Music Creation](/blog/musicagent-yamnet-integration-for-enhanced-music-creation/)
-   [AI Grooves: Finding the Funk with SentenceTransformers](/blog/ai-grooves-finding-the-funk-with-sentencetransformers/)
-   [Local Embedding: The Secret Sauce for Smarter AI in MusicAgent!](/blog/local-embedding-the-secret-sauce-for-smarter-ai-in-musicagent/)
-   [Music Agent v1.4.0 – Smarter, Faster, and Ready to Groove!](/blog/music-agent-v1-4-0-smarter-faster-and-ready-to-groove/)
-   [MusicAgent v1.5.0 – Creative Mode Is Here!](/blog/musicagent-v1-5-0-creative-mode-is-here/)

---

Music Agent @ Techorama 2025

[https://techorama.be/agenda/session/programming-harmony-a-20minute-jam-session](https://techorama.be/agenda/session/programming-harmony-a-20minute-jam-session)
