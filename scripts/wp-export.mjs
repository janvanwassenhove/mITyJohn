...
const APP_META = {
  ...
  sportsmadness: { name: 'Sports Madness', code: 'SPORT', tag: 'fun', cat: 'fun', order: 9, demoUrl: 'https://janvanwassenhove.github.io/sportsmadness', repo: 'sportsmadness', blurb: 'Drops short-lived "boosters" and "maddies" into a normal match, so any sport turns strategic and slightly chaotic.' },
  mitystories: { name: 'mITyStories', code: 'STORY', tag: 'fun', cat: 'fun', order: 10, blurb: 'Generates complete illustrated picture books and comics — in English, Dutch, Flemish and French.' },
  typix: { name: 'Typix', code: 'TYPIX', tag: 'fun', cat: 'fun', order: 11, demoUrl: 'https://janvanwassenhove.github.io/Typix', repo: 'Typix', blurb: 'Personality assessments that are actually fun: DISC, Enneagram and more, mapped to colour and energy zones.' },
  mitylaundry: { name: 'mITyLaundry', code: 'WASH', tag: 'fun', cat: 'fun', order: 12, demoUrl: 'https://janvanwassenhove.github.io/mITyLaundry', repo: 'mITyLaundry', blurb: 'Point your camera at a garment and it sorts the wash for you — AR, entirely in the browser. Sorting socks: still not automated in 2026.' },
  mitylex: { name: 'mITyLex', code: 'LEX', tag: 'fun', cat: 'fun', order: 13, demoUrl: 'https://janvanwassenhove.github.io/mITyLex', repo: 'mITyLex', blurb: 'Language learning built by a developer who got tired of the big apps. Short lessons, clear goals, visible progress.' },
